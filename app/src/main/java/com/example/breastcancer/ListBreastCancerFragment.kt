...
class ListBreastCancerFragment : Fragment() { 
	...
	override fun onResume() {
		super.onResume()
		(root as RecyclerView).adapter = BreastCancerRecyclerViewAdapter(model.listBreastCancer(), mListener!!)
	}
	...
	interface OnListBreastCancerFragmentInteractionListener {
		fun onListBreastCancerFragmentInteraction(item: BreastCancerVO)
	}
}
